...
class idParseHtml(ParserBase):
    def __init__(self, input_file_name):
        ...
        self.tag_type_dict = {'head':r'^Title \d','junk': r'Title \d', 'ul': r'^Chapter','head3':r'^§',
                              'head4': '^STATUTORY',
    ...
    def remove_junk(self):
        ...
        if title := re.search(r'Title\s(?P<title>\d+)',
                              self.soup.find('p', class_=self.tag_type_dict['head']).get_text(), re.I):
...
"""
    ...
    #     print("validating")
    #     # html5validate.validate(soup_str)/home/mis/cic-code-id/transforms/id/ocid/r70
